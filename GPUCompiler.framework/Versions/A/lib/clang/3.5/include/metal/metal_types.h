...
#define METAL_ASM
// TODO: The noduplicate attribute is useless and shall be removed once LLVM
// properly implements convergent -- see <rdar://problem/26307602>.
#define METAL_CONVERGENT __attribute__((convergent,noduplicate))
...
#if defined(__HAVE_PARTIAL_ORDER_ATOMIC__)
#define _AIR_MEM_ORDER_ACQUIRE 0x2
#define _AIR_MEM_ORDER_RELEASE 0x3
#define _AIR_MEM_ORDER_ACQ_REL 0x4
#define _AIR_MEM_ORDER_SEQ_CST 0x5
#endif
...
#if defined(__HAVE_PARTIAL_ORDER_ATOMIC__)
  memory_order_acquire = _AIR_MEM_ORDER_ACQUIRE,
  memory_order_release = _AIR_MEM_ORDER_RELEASE,
  memory_order_acq_rel = _AIR_MEM_ORDER_ACQ_REL,
  memory_order_seq_cst = _AIR_MEM_ORDER_SEQ_CST
#endif
};
...
// 5.12.2 Memory Scope
enum memory_scope {
  memory_scope_threadgroup = _AIR_MEM_SCOPE_WORK_GROUP,
  memory_scope_device = _AIR_MEM_SCOPE_DEVICE
};

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wtautological-compare"
template <>
struct _constarg_traits<memory_scope> {
  constexpr static METAL_INTERNAL bool check(memory_scope scope) { return scope == scope; }
};
#pragma clang diagnostic pop
#endif
